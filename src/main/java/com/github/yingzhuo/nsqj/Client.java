...
public class Client {
    ...
    public synchronized boolean stop(int waitMillis) {
        ...
        log.debug("handlerExecutor.isTerminated:{} schedExecutor.isTerminated:{} isClean:{}", handlerExecutor != null ? handlerExecutor.isTerminated() : "null", schedExecutor.isTerminated(), isClean);
